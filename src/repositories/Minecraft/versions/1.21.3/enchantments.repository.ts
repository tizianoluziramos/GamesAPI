...
import { Enchantments } from "../../../../models/Minecraft/versions/1.21.3/enchantments.model";

class enchantments {
  private cache?: Enchantments[];
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.21.3", "enchantments.json");

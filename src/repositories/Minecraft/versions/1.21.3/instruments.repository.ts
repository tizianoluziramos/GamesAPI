...
import { Instruments } from "../../../../models/Minecraft/versions/1.21.3/instruments.model";

class instruments {
  private cache?: Instruments[];
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.21.3", "instruments.json");

...
import { BlockCollisionShapes } from "../../../../models/Minecraft/versions/1.21.1/blockColissionShapes.model";

class blockColissionShapes {
  private cache?: BlockCollisionShapes;
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.21.1", "blockCollisionShapes.json");

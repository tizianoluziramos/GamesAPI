...
import { Attributes } from "../../../../models/Minecraft/versions/1.21.1/attributes.model";

class attributes {
  private cache?: Attributes[];
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.21.1", "attributes.json");

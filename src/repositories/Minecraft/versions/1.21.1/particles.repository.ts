...
import { Particles } from "../../../../models/Minecraft/versions/1.21.1/particles.model";

class particles {
  private cache?: Particles[];
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.21.1", "particles.json");

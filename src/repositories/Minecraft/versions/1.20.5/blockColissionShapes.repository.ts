...
import { BlockCollisionShapes } from "../../../../models/Minecraft/versions/1.20.5/blockColissionShapes.model";

class blockColissionShapes {
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.20.5", "blockCollisionShapes.json");

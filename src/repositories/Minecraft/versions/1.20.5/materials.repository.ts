...
import { Materials } from "../../../../models/Minecraft/versions/1.20.5/materials.model";

class materials {
  private cache?: Materials;
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.20.5", "materials.json");

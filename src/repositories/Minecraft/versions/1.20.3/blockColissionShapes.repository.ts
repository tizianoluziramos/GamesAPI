...
import { BlockCollisionShapes } from "../../../../models/Minecraft/versions/1.20.3/blockColissionShapes.model";

class blockColissionShapes {
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.20.3", "blockCollisionShapes.json");

...
import { Materials } from "../../../../models/Minecraft/versions/1.20.3/materials.model";

class materials {
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.20.3", "materials.json");

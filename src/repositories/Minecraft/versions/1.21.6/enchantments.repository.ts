...
import { Enchantments } from "../../../../models/Minecraft/versions/1.21.6/enchantments.model";

class enchantments {
  private cache?: Enchantments[];
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.21.6", "enchantments.json");

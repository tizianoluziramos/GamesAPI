...
import { Particles } from "../../../../models/Minecraft/versions/1.20.2/particles.model";

class particles {
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.20.2", "particles.json");

...
import { Commands } from "../../../../models/Minecraft/versions/1.20.2/commands.model"; // Asegurate de que este path sea correcto

class CommandsRepository {
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.20.2", "commands.json");

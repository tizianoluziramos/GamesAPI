...
import { Instruments } from "../../../../models/Minecraft/versions/1.20.2/instruments.model";

class instruments {
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.20.2", "instruments.json");

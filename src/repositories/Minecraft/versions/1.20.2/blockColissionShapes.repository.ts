...
import { BlockCollisionShapes } from "../../../../models/Minecraft/versions/1.20.2/blockColissionShapes.model";

class blockColissionShapes {
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.20.2", "blockCollisionShapes.json");

...
import { Materials } from "../../../../models/Minecraft/versions/1.20.2/materials.model";

class materials {
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.20.2", "materials.json");
  ...
  private async readData(): Promise<Materials> {
    ...
    const result: Materials = JSON.parse(data);

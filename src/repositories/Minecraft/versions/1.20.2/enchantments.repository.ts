...
import { Enchantments } from "../../../../models/Minecraft/versions/1.20.2/enchantments.model";

class enchantments {
  private dataPath = path.join(__dirname, "..", "..", "..", "..", "data", "Minecraft", "versions", "1.20.2", "enchantments.json");

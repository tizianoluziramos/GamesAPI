...
import { School, Spells } from "../../models/TheElderScrollsVSkyrim/spells.model";

class spells {
  private cache?: Spells[];
  private dataPath: string = path.join(__dirname, "..", "..", "data", "TheElderScrollsVSkyrim", "spells.json");
